...
var _themeSniffer = __webpack_require__(5);
...
(0, _jquery2.default)(function () {
  var $sniffReport = (0, _jquery2.default)('.js-sniff-report');
  var $progressBar = (0, _jquery2.default)('.js-progress-bar');
  var $snifferInfo = (0, _jquery2.default)('.js-sniffer-info');
  var $checkNotice = (0, _jquery2.default)('.js-check-done');
  ...
  (0, _jquery2.default)('#check-status').on('click', function () {
...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); /* global localizationObject */
...
var ThemeSniffer = function () {
  ...
  _createClass(ThemeSniffer, [{
    ...
    value: function themeCheckRunPHPCS(theme, warningHide, outputRaw, minPHPVersion, selectedRulesets) {
      ...
      return (0, _ajax2.default)({
        ...
        if (response.success === true) {
          ...
          var fileNumber = 0;
          var themeFiles = themeFilesRaw.reduce(function (result, value) {
            result[fileNumber] = value;
            fileNumber++;
            return result;
          }, {});
          _this.individualSniff(themeName, themeArgs, themeFiles, totalFiles, fileNumber = 0);
        } else {
          _this.$snifferInfo.addClass(_this.SHOW_CLASS);
          _this.$snifferInfo.html(response.data[0].message);
          _this.$progressBar.addClass(_this.SHOW_ERROR_CLASS);
        }
    ...
    value: function individualSniff(name, args, themeFiles, totalFiles, fileNumber) {
      ...
      return (0, _ajax2.default)({
        ...
        if (fileNumber < totalFiles) {
          _this2.individualSniff(name, args, themeFiles, totalFiles, fileNumber);
        } else {
        ...
        if (xhr.status === 500) {
          ...
          _this2.$progressBar.addClass(_this2.SHOW_ERROR_CLASS);
    ...
    value: function bumpProgressBar(count, totalFiles) {
      ...
      (0, _jquery2.default)('.progress-bar').html('<span>' + localizationObject.percentComplete + ' + ' + completed + '%</span>').append('<span class="meter" style="width:' + completed + '%"></span>');
    }
  }]);
...
function ajax(options) {
  return new Promise(function (resolve, reject) {
    _jquery2.default.ajax(options).done(resolve).fail(reject);
  });
}
