...
* Download [zip file](https://github.com/ernilambar/theme-sniffer/releases/download/0.1.4/theme-sniffer.0.1.4.zip). [Note: Please use this distribution plugin zip. GitHub provided zip will not work.]
